...
```{r}
# tsoni and Melody server  some projects need to be validated whether they are shotgun data
ALL_cleaned %>% 
  filter(str_detect(directory, 'peledj|smithm4')) %>% 
  arrange(directory, sampleid)  %>% 
  write_csv('../output/tm_samples.csv')
